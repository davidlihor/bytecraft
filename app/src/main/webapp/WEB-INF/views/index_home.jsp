    ...
    <nav class="navbar navbar-custom navbar-static-top" role="navigation" style="background-color: #e3f2fd;">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="${contextPath}/welcome">ByteCraft</a>
            </div>
...
<header class="w3-display-container w3-content w3-wide" style="max-width:1500px;" id="home">
  <img class="w3-image" src="${contextPath}/resources/Images/dev_img.jpeg" alt="Architecture" style="width: 100vw;">
</header>
<div>
<blockquote><p>
     <h2 align="center" style="font-family: Verdana,sans-serif;color:#1C3B47;">Learning...</h2>
  ...
  <div class="container w3-padding-32" id="about">
    ...
    <div class="w3-content" style="max-width:864px">
	     <p style="text-align:justify;">
                    We are dedicated to delivering innovative technology solutions. Founded with a mission to leverage cutting-edge technology and unparalleled expertise, we specialize in creating high-quality software solutions that drive business success.
                </p>
                <p style="text-align:justify;">
                ...
                <p style="text-align:justify;">
                    Here, we focus on understanding our clients' unique needs and providing tailored solutions that meet their objectives. Whether it's custom software development, system integration, or ongoing support, we are committed to excellence and client satisfaction.
                </p>
                <p style="text-align:justify;">
                    With a commitment to staying ahead of technological trends and a passion for innovation, we are your trusted partner in navigating the digital landscape and achieving your business goals.
                </p>
                <p><strong>Address:</strong> Punjagutta Colony Ameerpet, Hyderabad</p>
                <p><strong>Phone:</strong> +8001234567</p>
                <p><strong>Email:</strong> bytecraft@gmail.com</p>
  	</div>
   </div>
