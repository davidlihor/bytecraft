...
<div class="mainbody container-fluid">
    <div class="row">
                ...
                <nav class="navbar navbar-custom navbar-static-top" role="navigation">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            ...
                            <!-- Navbar Brand -->
                            <a class="navbar-brand" href="/index">ByteCraft</a>
                        </div>
                        <!-- Navbar Links -->
                        <div class="navbar-collapse collapse">
                            <ul class="nav navbar-nav">

                                <li><a href="#devops">My Activity</a></li>
                               <li>
                                ...
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                        <span class="user-avatar pull-left" style="margin-right: 8px; margin-top: -5px;">
                                            <img src="${contextPath}/resources/Images/user/user3.png" class="img-responsive img-circle" title="John Doe" alt="John Doe" width="30px" height="30px">
                                        </span>
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <div class="navbar-content">
                                                <div class="row">
                                                    <div class="col-md-5">
                                                        <img src="${contextPath}/resources/Images/user/user3.png" alt="Alternate Text" class="img-responsive" width="120px" height="120px" style="border-radius: 50%;" />
                                                    ...
                                                    <div class="col-md-7">
                                                        ...
                                                        <p class="text-muted small">
                                                            ${pageContext.request.userPrincipal.name}@gmail.com
                                                        </p>
        ...
        <div class="col-lg-3 col-md-3 hidden-sm hidden-xs" style="border-radius: 50%;">
            <div class="panel panel-default" style="border-radius: 10px;">
                <div class="panel-body">
                    <div class="media">
                        <div align="center">
                            <img class="thumbnail img-responsive" src="${contextPath}/resources/Images/user/user3.png" width="300px" height="300px" style="border-radius: 20px;">
                        </div>
        ...
        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                ...
                <div class="panel-body">
                    <span>
                      ...
                      <%
                          ...
                          String username = auth != null ? auth.getName() : "to ByteCraft";
                      %>
            ...
            <div class="panel panel-default" style="border-radius: 10px;">
                <div class="panel-body">
                    ...
                    <hr>
                    <div class="media">
                        <div class="media-body" id="devops">
                            <textarea class="form-control" rows="1" placeholder="Comment"></textarea>
                        </div>
                    </div>
                </div>
            ...
            <div class="panel panel-default" style="border-radius: 10px;">
                <div class="panel-body">
                    <div class="pull-left">
                        <a href="#">
                            <img class="media-object img-circle" src="${contextPath}/resources/Images/user/user3.png" width="50px" height="50px" style="margin-right:8px; margin-top:-5px;">
                        </a>
                    </div>
                    <h4><a href="#" style="text-decoration:none;"><strong>${pageContext.request.userPrincipal.name}</strong></a><small><small><a href="#" style="text-decoration:none; color:grey;"><i><i class="fa fa-clock-o" aria-hidden="true"></i> 42 minutes ago</i></a></small></small></h4>
                    <span>
                    ...
                    <hr>
                    <div class="post-content">
                        <p>Work with DevOps</p>
                        <img class="img-responsive" src="${contextPath}/resources/Images/devops_img.png" style="width: 300px; border-radius: 5px;">
